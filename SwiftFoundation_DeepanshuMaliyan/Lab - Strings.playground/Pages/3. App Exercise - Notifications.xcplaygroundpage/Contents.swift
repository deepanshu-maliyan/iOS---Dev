 ...
 */
let firstName: String = "Deepanshu"
let lastName: String = "Maliyan"
...
let newBest = 15125
let congratulations = "Conratulation, \(fullName)! You beat your previous daily high score of \(previousBest) steps by walking \(newBest) steps yesterday!"
