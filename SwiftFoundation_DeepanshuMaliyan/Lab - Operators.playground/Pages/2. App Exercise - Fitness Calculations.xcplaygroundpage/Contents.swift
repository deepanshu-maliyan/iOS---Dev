...
// yes they are different values as averageHR ONLY CAN CALCULATE INT VALUES FROM EXACT DECIMAL VALUE AND THE averageHRD SHOWS EXACTLY THE SAME CALCULATED VALUE I,E, DECIMAL OR FLOAT
