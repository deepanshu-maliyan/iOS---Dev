...
{
    steps += 1
    print("Your Step-Count is \(steps)")
...
let goal = 10000.0
let stepsCount = 8000.0
func progressUpdate(goal: Double){
    if stepsCount<0.1*goal{
        print("You're off to a good start.")
    }
    else if stepsCount<goal*0.5{
        print("You're almost halfway there!")
    }
    else if stepsCount<goal*0.9{
