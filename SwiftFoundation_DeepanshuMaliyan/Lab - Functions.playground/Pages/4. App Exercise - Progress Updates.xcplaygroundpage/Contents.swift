 ...
 */
func progressUpdate(stepsCount: Int, goal: Int){
    if stepsCount<goal/10{
        print("You're off to a good start.")
    }
    else if stepsCount<goal/2{
        print("You're almost halfway there!")
    }
    else if stepsCount<goal*(9/10){
        print("You're over halfway there!")
    }
    else if stepsCount<goal{
...
progressUpdate(stepsCount: 4000, goal: 10000)
...
pacing(currentDistance: 100, totalDistance: 1000, currentTime: 22, goalTime: 25)


pacing(currentDistance: 500, totalDistance: 1000, currentTime: 25, goalTime: 55)
/*:
